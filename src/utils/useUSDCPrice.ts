import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@nexuslayer/sdk'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.CAPY ? USDC : undefined],
      [chainId ? WETH[chainId] : undefined, chainId === ChainId.CAPY ? USDC : undefined]
    ],
